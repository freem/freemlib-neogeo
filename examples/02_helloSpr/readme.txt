...
../../src/inc/input.inc			Input-related Functions and Macros
...
Note: Horizontal shrink values do not propogate through chained sprites.
...
"What the heck is a Sprite Data Block?" It's something one of the macros generates.

(sprmac_SpriteData)
sprmac_SpriteData is a macro that inserts Sprite Data Blocks into the binary.
This macro is used to construct the "World!!!" metasprite.
...
Metasprite Data Blocks are refreshingly simple compared to the other Sprite-related
blocks:
